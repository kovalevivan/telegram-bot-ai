...
- **DB**: `DATABASE_URL`
- **PDF**: `PDF_LOGO_PATH`, `PDF_FONT_PATH`, `PDF_FONT_BOLD_PATH`, `PDF_BODY_FONT_PATH`, `PDF_BODY_FONT_BOLD_PATH`, `PDF_BODY_FONT_ITALIC_PATH`, `PDF_BODY_FONT_BOLD_ITALIC_PATH` (по умолчанию фон в `app/static/dailymind-hero.jpg`, body‑шрифт Apple Color Emoji для поддержки эмодзи)
